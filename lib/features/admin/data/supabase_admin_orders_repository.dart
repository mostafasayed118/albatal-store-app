...
/// Supabase-backed implementation of [AdminOrdersPort] — the fulfillment
/// queue slice of the former 22-method `SupabaseAdminRepository` god-class
/// (audit 2026-09-21, P1 split). One concern, one class, one file.
final class SupabaseAdminOrdersRepository implements AdminOrdersPort {
  SupabaseAdminOrdersRepository({required SupabaseClient client})
      : _client = client;
