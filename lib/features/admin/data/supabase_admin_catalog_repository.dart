...
/// Supabase-backed implementation of [AdminCatalogPort] — the catalog- and
/// variant-management slice of the former 22-method
/// `SupabaseAdminRepository` god-class (audit 2026-09-21, P1 split).
final class SupabaseAdminCatalogRepository implements AdminCatalogPort {
  SupabaseAdminCatalogRepository({required SupabaseClient client})
      : _client = client;
