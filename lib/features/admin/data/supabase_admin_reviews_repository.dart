...
/// Supabase-backed implementation of [AdminReviewsPort] — the review
/// moderation slice of the former 22-method `SupabaseAdminRepository`
/// god-class (audit 2026-09-21, P1 split).
final class SupabaseAdminReviewsRepository implements AdminReviewsPort {
  SupabaseAdminReviewsRepository({required SupabaseClient client})
      : _client = client;
