...
/// Supabase-backed implementation of [AdminCouponsPort] — the coupon
/// management slice of the former 22-method `SupabaseAdminRepository`
/// god-class (audit 2026-09-21, P1 split).
final class SupabaseAdminCouponsRepository implements AdminCouponsPort {
  SupabaseAdminCouponsRepository({required SupabaseClient client})
      : _client = client;
