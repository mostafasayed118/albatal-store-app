...
class DetailsPage extends StatelessWidget {
  const DetailsPage({
    ...
    required this.productShareService,
  ...
  /// WhatsApp-first option. Resolved at the composition root.
  final ProductShareService productShareService;
            ...
            appBar: AppBar(
              ...
              actions: [
                ...
                IconButton(
                  ...
                  onPressed: () => unawaited(productShareService.shareText(
