...
void main() {
  group('CatalogConstants.swatchFor', () {
    ...
    test('unknown names resolve deterministically', () {
      final a = CatalogConstants.swatchFor('Zanzibar Weave');
      final b = CatalogConstants.swatchFor('zanzibar weave');
      expect(a, b);
    ...
    test('different unknown names do not silently share a hue', () {
      ...
      expect(
        CatalogConstants.deterministicTint('Zanzibar') !=
            CatalogConstants.deterministicTint('Kashmir'),
        isTrue,
      );
    });
  });
