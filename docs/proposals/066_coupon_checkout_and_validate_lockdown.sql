-- ═══════════════════════════════════════════════════════════════════
-- 066 (PROPOSAL — NOT APPLIED): coupons end-to-end + validate_coupon
-- lockdown
--
-- Owner-review draft for OWNER_ACTIONS.md Issues 1 + 2 (P1 money path
-- / P1 security). This file lives under docs/proposals/ ON PURPOSE:
-- AGENTS.md freezes supabase/migrations for auto-edits. After review,
-- COPY it to supabase/migrations/066_coupon_checkout_and_lockdown.sql
-- and apply to STAGING first (041/046/060 deploy-gate precedent).
--
